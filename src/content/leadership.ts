...
export const chairmanMessage = {
  quote:
    "For more than three decades, Your Company has stood for one promise: to build with integrity, deliver with discipline, and earn the confidence of every client we serve. Under the Your Group, that commitment is not a slogan. It is the standard by which we measure every project, every partnership, and every structure we leave behind.",
  author: "Your Company Leadership",
  role: "Your Company Pvt. Ltd.",
...
export const leaders: Leader[] = [
  {
    id: "chairman",
    name: "Your Group Leadership",
    role: "Parent Organization",
    bio: "Guiding Your Company with the institutional strength, strategic vision, and decades of real estate expertise that define the Your Group legacy in Nepal.",
  ...
  },
  {
    ...
    role: "Managing Director, Your Company",
  ...
  },
  {
    ...
    bio: "Directing on-site execution with rigorous quality control, safety compliance, and milestone-driven delivery across every Your Company build.",
...
export const leaderProfiles: Record<string, Omit<LeaderProfile, keyof Leader>> = {
  chairman: {
    message: {
      quote:
        "A building is more than steel and concrete. It is a commitment to the people who will live, work, and invest in it. The Your Group has upheld that responsibility across generations, and Your Company carries that same standard of trust into every project we undertake.",
      body: [
        "Your Company operates as part of the Your Group, one of Nepal's most established names in real estate and construction. That relationship provides more than a name on a letterhead. It provides institutional depth: experienced governance, financial discipline, and a long-term view that short-cycle builders simply cannot replicate.",
        "Our leadership philosophy rests on four pillars that guide every decision at Your Company: excellence in execution, integrity in every client relationship, innovation in how we build, and collaboration across teams, partners, and communities. These are not values posted on a wall. They are the criteria we use to evaluate our own performance.",
        "From A-Class licensed construction to integrated investment and consulting services, Your Company exists to give clients a single, accountable partner for projects that matter. Whether the scope is a family residence, a commercial development, or a specialized facility, our standard remains the same: deliver work that is structurally sound, transparently managed, and worthy of the Your Group name.",
    ...
    articles: [
      {
        ...
        title: "Heritage, Governance, and the Your Group Vision for Nepal",
        excerpt:
          "How institutional leadership and generational expertise under Your Group continue to define Your Company's standards for construction excellence.",
        body: [
          "The Your Group's presence in Nepal's real estate and construction sector reflects a record built over decades, not through volume alone, but through consistent delivery, ethical practice, and relationships that endure beyond project completion. That institutional memory is one of Your Company's most valuable assets.",
          "Governance matters in construction. Clients entrust significant capital, time, and expectation to their builder. Under Your Group leadership, Your Company maintains the financial stability, oversight structures, and quality systems that allow us to honor that trust from initial consultation through final handover and beyond.",
          "Our vision extends past individual developments. We invest in skilled teams, reliable supply relationships, and construction practices that raise the bar for the industry in Nepal. Your Company was established in 1995 and holds A-Class certification precisely because we treat that responsibility with the seriousness it demands.",
      ...
      },
      {
        ...
        body: [
          ...
          "The Your Group structure provides that continuity. Shared standards across the group, experienced leadership at every level, and a reputation tested across multiple economic cycles mean Your Company clients benefit from stability that independent operators often cannot offer.",
          ...
          "Trust, in our view, is earned through performance and protected through governance. Your Group leadership remains committed to both across every Your Company engagement.",
        ],
        category: "Strategy",
        date: "2024-11-08",
        readTime: "5 min read",
  ...
  md: {
    message: {
      quote:
        "Leadership at Your Company means creating the conditions for excellence: clear accountability, disciplined processes, and a culture where every team member understands that the client's trust is our most valuable asset.",
      body: [
        "As Managing Director, I am responsible for ensuring that Your Company's three divisions (Construction, Investment, and Consulting & Design) operate not as isolated units, but as an integrated platform serving a single client objective: successful project outcomes.",
        ...
        "Your Company has served clients across Kathmandu and beyond for more than thirty years. That longevity is not accidental. It is the result of a management philosophy that treats every inquiry seriously, every contract honorably, and every completed project as a reference for the next.",
      ],
    },
    articles: [
      {
        slug: "operational-excellence-at-your-company",
        title: "Integrated Leadership: How Your Company's Divisions Work as One",
        excerpt:
        ...
        body: [
          ...
          "Your Company was structured deliberately to prevent that outcome. Our divisions function under unified executive oversight, ensuring that design intent, budget alignment, and site execution remain synchronized from feasibility through completion.",
      ...
      },
      {
        ...
        excerpt:
          "Why honest communication, structured reporting, and executive accessibility define the Your Company client experience.",
        body: [
          "Clients select Your Company because they expect a partner, not a vendor who disappears after signing. That expectation shapes every element of our delivery model, from the first site meeting to the final inspection walkthrough.",
          ...
          "Accountability is personal to us. When Your Company commits to a deliverable, our leadership stands behind it. Our reputation, built since 1995, depends on nothing less.",
        ],
        category: "Management",
        date: "2024-12-05",
        readTime: "4 min read",
  ...
  "construction-head": {
    message: {
      quote:
        "On every Your Company site, we hold ourselves to a simple standard: build it right, build it safely, and deliver what was agreed on schedule, on specification, and without compromise.",
      body: [
        "Construction management is where design intent meets physical reality. Our project management team bears direct responsibility for that transition, coordinating trades, materials, inspections, and schedules while maintaining the quality and safety standards that define Your Company.",
        ...
        "Safety is non-negotiable. Every active Your Company site operates under established protocols covering worker training, equipment standards, and environmental protection. We comply with applicable building codes and regulatory requirements not as a minimum threshold, but as the baseline from which our own standards exceed.",
    ...
    articles: [
      {
        ...
        title: "Quality Assurance and Site Safety: The Your Company Standard",
        excerpt:
        ...
        body: [
          "Quality assurance at Your Company is a structured process, not an aspiration. Before ground is broken, project managers conduct comprehensive reviews of drawings, specifications, and material schedules to confirm alignment with client requirements and regulatory standards.",
          ...
          "Safety management runs parallel to quality control. Worker orientation, personal protective equipment requirements, equipment inspections, and site access protocols are enforced consistently across all Your Company projects. Protecting our teams and the communities adjacent to our sites is a leadership responsibility we do not delegate.",
          "The result is a construction process that clients can observe with confidence, knowing that what they see on site reflects the standards we committed to in contract and the reputation Your Company has maintained for more than three decades.",
        ],
      ...
      },
      {
        ...
        excerpt:
          "Realistic planning, proactive risk management, and weekly coordination: the practices that keep Your Company projects moving forward.",
        body: [
  ...
  "design-head": {
    message: {
      quote:
        "Architecture must inspire, but engineering must protect. At Your Company, our design team unites both disciplines from the first sketch, because a beautiful building that fails structurally serves no one.",
      body: [
        ...
        "Every drawing that leaves our office carries Your Company's A-Class commitment: structurally sound, code-compliant, and ready for the disciplined execution our construction teams are known for.",
      ],
    },
    articles: [
      {
        ...
        body: [
          "The most common source of design-related construction delay is not complexity. It is disconnect. When architectural and structural disciplines operate in isolation, conflicts emerge on site that should have been resolved on paper. Your Company's integrated design team exists to prevent exactly that outcome.",
      ...
      },
      {
        ...
        excerpt:
          "How Your Company's engineering team applies seismic analysis, code compliance, and quality-controlled construction to protect lives and investments.",
        body: [
          ...
          "Clients who invest in proper seismic design protect more than property. They protect the people who will occupy their buildings. Your Company accepts that responsibility as fundamental to every project we design and deliver.",
        ],
